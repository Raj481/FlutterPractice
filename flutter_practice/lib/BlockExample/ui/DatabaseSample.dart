...
import 'package:flutter_practice/BlockExample/bloc/blocs/TodoBloc.dart';
import 'package:flutter_practice/BlockExample/models/Todo.dart';
                          ...
                          Padding(
                            ...
                            child: CircleAvatar(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  final newTodo = Todo( description: _todoDescriptionFormController.value.text );
                      ...
                      child: ListTile(
                        leading: InkWell(
                          onTap: () {
                            ...
                            /* Another magic. This will update Todo isDone with either
                              completed or not */
